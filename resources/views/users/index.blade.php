    ...
    <div class="row">
        ...
        <div class="col-md-10 mb-3">
            <div class="row">
                ...
                <!-- Search Form -->
                <form action="{{ route('users.index') }}" method="GET" class="search-form col-md-12 mb-3">
                        ...
                        <tbody>
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td class="align-middle" style="font-size: 0.9rem;">{{ $user->gender->gender }}</td>
